...
inner_frame = tk.Frame(root,bg='gray87')
inner_frame.pack(side=tk.TOP, fill=tk.X)
...
label_left = tk.Label(inner_frame, image=image_left,bg='gray87')
label_left.grid(row=0, column=0, padx=10)

image_center = tk.PhotoImage(file="imagenes/logM1.png")#m2ph
label_center = tk.Label(inner_frame, image=image_center,bg='gray87')
label_center.grid(row=0, column=1)

image_right = tk.PhotoImage(file="imagenes/92.png")
label_right = tk.Label(inner_frame, image=image_right,bg='gray87')
...
label_texto = tk.Label(root, text=texto, justify="center",wraplength=1000, width=1400,bg="blue4", fg="white", font=("Arial", 10,'bold'))
