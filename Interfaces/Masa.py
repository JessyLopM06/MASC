"""
Este módulo proporciona una interfaz de masa_activa de usuario utilizando tkinter.
"""
...
active_mass = tk.Label(root, text='Mass of active material :', bg='#003399',
...
def crear_caja_texto(etiqueta_texto):
    frame = tk.Frame(root)
    frame.pack(pady=6)
>>>>>>> 63f9ff6d0158490ba5f4ae6f0949c8a55d1330bf

active_mass = tk.Entry(root,width=20, font=('Arial',12),highlightbackground='blue4',
...
density = tk.Entry(root,width=20, font=('Arial',12),highlightbackground='blue4',
                highlightthickness=3)
