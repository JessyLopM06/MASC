"""
Este módulo proporciona una interfaz de los Comentarios de usuario utilizando tkinter.
"""
...
def guardar_datos():
    global nombre1, apellido1, edad1, correo1, telefono1, comentarios1
    datos = {'Nombres': nombre1, 'Apellidos': apellido1, 'Fecha': edad1,
            'Correo': correo1, 'Telefono': telefono1, 'Comentarios': comentarios1}
...
#nombre
nombre = Label(frame1, text='👤 Name', bg='#003399', font=('Arial', 12, 'bold'),
        fg='white', width=12)
nombre.grid(column=0, row=1, pady=10, padx=10)

ingresa_nombre = Entry(frame1, width=20, font=('Arial', 12), highlightbackground="blue4",
    highlightthickness=3)
ingresa_nombre.grid(column=1, row=1)

#apellido
apellido = Label(frame1, text='👥 Last name', bg='#003399', font=('Arial', 12, 'bold'),
    fg='white', width=12)
apellido.grid(column=0, row=2, pady=10, padx=10)
...
#edadd
edad = Label(frame1, text='📅 Date', bg='#003399', font=('Arial', 12, 'bold'),
    fg='white', width=12)
edad.grid(column=0, row=3, pady=10, padx=10)

ingresa_edad = Entry(frame1, width=20, font=('Arial', 12), highlightbackground="blue4",
    highlightthickness=3)
ingresa_edad.grid(column=1, row=3)

#correo
correo = Label(frame1, text='@ Mail', bg='#003399', font=('Arial', 12, 'bold'),
    fg='white', width=12)
correo.grid(column=0, row=4, pady=10, padx=10)
...
#telefono
telefono = Label(frame1, text='📞 Phone', bg='#003399', font=('Arial', 12, 'bold'),
    fg='white', width=12)
telefono.grid(column=0, row=5, pady=10, padx=10)

ingresa_telefono = Entry(frame1, width=20, font=('Arial', 12),highlightbackground="blue4",
    highlightthickness=3)
ingresa_telefono.grid(column=1, row=5)

#comentarios
comentarios_label = Label(frame1, text='💬 Comments', bg='#003399',
    font=('Arial', 12, 'bold'), fg='white', width=12)
comentarios_label.grid(column=0, row=6, pady=40, padx=10)

ingresa_comentarios = Text(frame1, height=4, width=20, font=('Arial', 12),
    highlightbackground="blue4", highlightthickness=4)
ingresa_comentarios.grid(column=1, row=6)

# Boton Agregar
agregar = Button(frame1, width=20, font=('Arial', 12, 'bold'), fg='white', text='✔ Add',
    bg='blue4', bd=5, command=agregar_datos)
agregar.grid(columnspan=2, row=7, pady=20, padx=10)

archivo = Label(frame2, text='📁 Enter File Name', width=20, bg='#003399',
    font=('Arial', 12, 'bold'), fg='white')
# Reducir el espacio vertical entre el label y el resto de widgets
archivo.grid(column=0, row=1, pady=(120, 10), padx=20) 

nombre_archivo = Entry(frame2, width=20, font=('Arial', 12), highlightbackground="blue4",
    highlightthickness=4)
nombre_archivo.grid(column=0, row=2, padx=20, pady=(0, 20), sticky="n")

# Boton Guardar
guardar = Button(frame2, width=20, font=('Arial', 12, 'bold'), fg='white',
    text='💾 Save data', bg='blue4', bd=5, command=guardar_datos)
...
# Boton Salir
guardar = Button(frame2, width=20, font=('Arial', 12, 'bold'), fg='white',
    text='❌ Close', bg='blue4', bd=5, command=cerrar_ventana)
