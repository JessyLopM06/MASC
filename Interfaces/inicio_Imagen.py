...
class Ventana(Tk):
    ...
    def ventana_login(self):
        ...
        lbl_titulo = Label(frame_contenido, text=" LOGIN ", font=('Arial', 20, 'bold'), fg='snow', bg='#003399')
        ...
        lblframe_login = LabelFrame(master=frame_derecho, text='Access', font=('Arial', 20, 'bold'), fg='snow', bg='#003399', padx=20, pady=20, borderwidth=10, highlightbackground='blue4')
        lblframe_login.pack(fill=BOTH, padx=80, pady=(100,100))

        lbl_usuario = Label(master=lblframe_login, text='👤 User : ', font=('Arial', 15, 'bold'), fg='snow', bg='#003399')
        lbl_usuario.grid(row=2, column=0, padx=5, pady=10)

        self.ent_usuario = ttk.Entry(master=lblframe_login, width=15, justify=CENTER, font=('Arial',15,'bold'))
        self.ent_usuario.grid(row=2, column=1, padx=5, pady=10)

        lbl_clave = Label(master=lblframe_login, text='🔑 Password :  ', font=('Arial', 15, 'bold'), fg='snow', bg='#003399')
        lbl_clave.grid(row=3, column=0, padx=5, pady=15)

        self.ent_clave = ttk.Entry(master=lblframe_login, width=15, justify=CENTER, show='*', font=('Arial',15,'bold'))
