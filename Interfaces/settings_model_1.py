...
Label(text='Scan rate mVs⁻¹', bg='#003399', font=('Arial', 12, 'bold'), fg='white', width=20).grid(column=0, row=0, pady=15, padx=10)
velocities_entry = Entry(width=10, font=('Arial', 12), highlightbackground="blue4",
